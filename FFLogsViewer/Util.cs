...
public class Util
{
    ...
    {
        OpenLink($"https://tomestone.gg/character-name/{charData.WorldName}/{charData.FirstName}");
    }
    ...
    {
        if (!ImGui.BeginPopupContextItem($"##LinkPopup{charData.FirstName}{charData.WorldName}{charData.GetHashCode()}", ImGuiPopupFlags.MouseButtonLeft))
        {
            return;
        }
